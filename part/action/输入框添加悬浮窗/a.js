...
function inputKey(){
    ...
    $(".searchkey-input").click(function(){
        if($(".searchkey-winbox").length==0){
            input.after("<div class='searchkey-winbox' style='position:absolute;width: 650px;top: 30px;padding: 10px;border: 1px #c8c8c8 solid;background-color:#fff;'><h4 style='margin:5px 0;'>热门商圈</h4><div class='winbox-list' style='text-algin:center'></div><h4 style='margin:5px 0;'>行政区</h4><div class='winbox-list' style='text-algin:center'></div><h4 style='margin:5px 0;'>机场火车站</h4><div class='winbox-list' style='text-algin:center'></div><h4 style='margin:5px 0;'>地铁线</h4><div class='winbox-list' style='text-algin:center'></div></div>");
            for(prop in keyword){
    ...
    $(".searchkey-box").on("click",".searchkey-winbox",function(){
